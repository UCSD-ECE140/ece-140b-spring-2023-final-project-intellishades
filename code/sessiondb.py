...
class SessionStore:
  ...
  def create(self, session_id:str, session_data:dict) -> None:
    ...
    query = "insert into user_sessions (session_id, session_data) values (%s, %s);"
  ...
  def read(self, session_id:str) -> dict:
    ...
    db = mysql.connect(**self.db_config)
    cursor = db.cursor()
    query = "select session_data, created_at from user_sessions where session_id = %s;"
  ...
  def delete_expired(self) -> None:
    ...
    query = "delete from user_sessions where created_at < %s;"
